...
public class Polipasto : MonoBehaviour
{
    [SerializeField] private GameObject _polea1;
    [SerializeField] private Rigidbody _polea2;
    ...
    void Update()
    {
        ...
        // _acc = (_object2.Masa / 2 * 10 - _object1.Masa * 10) / (_object1.Masa + _object2.Masa / 2);
        ...
        // _object2.SetTension(_tension * 2);
        // _object2.StopMovement = _object1._onGround;
        // _object1.StopMovement = _object2._onGround;
        // _tension = _masa1 * Mathf.Abs(_acc) + _masa1 * 10;
    }
